...
I created a character that made you feel like you were actually playing the game.  I added a single weapon to the player and there is only a single platform for the character to move around on.
